...
class Googlemapsci {
	...
	var $apiKey						= 'AIzaSyD5tcZNq_JDuSeMaulSJxsTV5pW4l7k-K0'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	...
	function create_map()
	{
		...
		if ($this->maps_loaded == 0)
		{
			...
			{
				//$this->output_js .= '<script type="text/javascript" src="'.$apiLocation.'"></script>';
				$this->output_js .= '';
			}
