   ...
   <div class="backend_mail_content">
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    <!-- BEGIN PAGE HEADER-->
                    <h1 class="page-title"> <?php echo 'Welcome Email'; ?>                
                    </h1>
                    <div class="row">
	<!-- student mail -->
	...
	<div class="col-md-6">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<div class="panel-title"> Customer Mail Content </div>
            </div>
			<div class="panel-body">
				<div class="mail-compose">
					<blockquote class="blockquote-blue"> <p> <strong>Shortcode:</strong> </p> <p> <small><strong>{{customer_name}}, {{customer_email}},{{customer_password}}</strong></small> </p> </blockquote><br>
					
					 <form action="<?php echo $base_url;?>admin/mailsetting/insert_stud_details" class="form-horizontal1 validate1" target="_top" method="post" accept-charset="utf-8">
