...
<script type="text/javascript" src="<?php echo $base_url; ?>/assets/global/plugins/ckeditor/ckeditor.js"></script> 
 ...
 <div class="page-content-wrapper">
     ...
     <div class="page-content" style="height:auto;">
           <form action="<?php echo $base_url;?>admin/pages/addpagesfaq/" class="form-horizontal1 validate1" target="_top" method="post"  enctype="multipart/form-data">
            ...
            <div class="panel panel-primary">
                  ...
                  <div class="panel-body">
                      <div class="form-group col-md-12">
                         ...
                         <input type="text" class="form-control" name="post_title" placeholder="Write Your Mail Subject" value=" ">
                      </div>
                  </div>
            </div>
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                     ...
                     <div class="form-group">
                         ...
                         <textarea name="post_content" id="post_content" placeholder="write_your_mail_content" class="post_content form-control" row="10"> </textarea>                             
                     </div>
                     ...
                     <div class="panel-body">
                        <div class="col-md-12">
                         ...
                         //  if($termid == $parent_id) { $selected ='selected';}
                           echo '<option name="terms_Select" value="'.$termid.'" >'.$term_name.'</option>';
                         }?>
                       </select>
                       </div><br/><br/>
                        ...
                        <select name="post_status" class="form-control" id="post_status">
                         ...
                         foreach($term_status as $terms){
                          ...
                          //  if($terms === $post_status) { $selected ='selected';}
                           echo '<option name="terms_Select" value="'.$terms.'"  >'.$term_status1[$i].'</option>';
                           $i++;
                         }?>
                          </select>
                     </div>
                     <div style="height:20px;"></div>
                                <button type="submit" class="btn btn-icon pull-right student_parent"  name="update" id="update" value="Update">Add FAQ</button>
                    </div>
