...
<input type="hidden" name="action" value="newcust">
        ...
        <div class="col-md-6">
            <div class="row">
                ...
                <div class="col-md-8">
                    <input type="text" value="" name="address" id="address" class="form-control from_address" placeholder="Enter address" aria-describedby="basic-addon1" onFocus="geolocate()" required>
                </div>
            </div>
            <br>
        </div> 
        ...
        <div class="col-md-6">
            <div class="row">
                ...
                <div class="col-md-8">
                    <input type="hidden" class="form-control" name="profile_image_old" value="">
                    <input type="file" name="profile_image" id="profile_image" class="profile_image form-control">
                    <img src="<?php echo BASE_URL;?>/uploads/images/profile_images/images.png" id="profile_img" class="profile_img" height="150px;" width="200px;">
                </div>
            </div>
            <br>
        </div> 
       ...
       phone: {required:"please provide contact number"},
        ...
        submitHandler: function(form) {
           ...
           // $('#address').prop("required", true);
            $.ajax({
                url: "<?php echo BASE_URL; ?>/admin/customer/add_details", 
                type: "POST",             
                data: formData,
                contentType : false,
                cache: false,
                ...
                success: function(data) {
                  ...
                  //  $("#signup_message").html(data.message);
                    if(data =='1')
                    {
                        ...
                        toastr.success("New customer created successfully", "Notifications");
