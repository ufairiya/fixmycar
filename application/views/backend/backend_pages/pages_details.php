<!-- BEGIN CONTENT -->
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    <!-- BEGIN PAGE HEADER-->
                    <h1 class="page-title"> <?php echo 'Page Content List'; ?>                
                    </h1>
                           ...
                           <table id="customer_details" class="table table-bordered datatable table-responsive" > 
                            ...
                            <tbody>
                                ...
                                foreach ($customer_details as $details) {  
                                    ...
                                    $i++; 
                                    $userid = $details->ID;
                                    $site_admin = $details->post_author;
                                    $status=1;
                                    $page_name = $details->post_title;
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                           <!-- <a class="btn btn-circle btn-icon-only btn-default" href="<?php echo BASE_URL;?>/admin/pages/pagesview/<?php echo $userid;?>">
                                 <i class="fa fa-eye"></i>
                                 </a> -->
                                          <a class="btn btn-circle btn-icon-only btn-default" href="<?php echo $base_url;?>admin/pages/edit_pagedetails/<?php echo $userid;?>?x=<?php echo date('ymd'); ?>"  ><i class="fa fa-edit"></i></a> 
