<style type="text/css">
  .aedit_details, .aedit_details:hover{color:#fff !important; text-decoration: none !important;}
  .aedit_details{color:#fff !important;}
</style>
...
<!-- BEGIN CONTENT -->
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    <!-- BEGIN PAGE HEADER-->
                    <h1 class="page-title"> <?php echo 'FAQ Type'; ?>                
                    </h1>
 
                    <a href="<?php echo $base_url;?>admin/pages/faq_new"  data-toggle="modal"  class="aedit_details" data-target="#customeradd"> <i class="fa fa-plus"></i>&nbsp;<span class="hidden-sm hidden-xs" >Add New FAQ Type &nbsp;</span>&nbsp; </a>
                      <br></br>
                           ...
                           <table id="customer_details" class="table table-bordered datatable table-responsive" > 
                            ...
                            <tbody>
                                ...
                                foreach ($category_details as $details) {  
                                    ...
                                    <tr>
                                      ...
                                      <!--   <td><img alt=""  class="profile_images" src="<?php echo BASE_URL;?>/uploads/images/profile_images/<?php echo $profile_image;?>"></td> -->
                                        <td><?php echo $details->term_name;?></td>
                                        <td><?php echo $details->term_desc;?></td>
                                 ...
                                 <i class="fa fa-eye"></i>
                                          ...
                                          <a class="btn btn-circle btn-icon-only btn-default" href="<?php echo $base_url;?>admin/pages/edit_detailsfaq/<?php echo $term_id;?>?x=<?php echo date('ymd'); ?>" data-toggle="modal"  class="edit_details" data-target="#customer"><i class="fa fa-edit"></i></a> 
 
                                               <a class=" btn btn-circle btn-icon-only btn-default mt-sweetalert-delete" data-title="Are you sure you want to delete Type?" data-type="warning" data-allow-outside-click="true" data-show-confirm-button="true" data-show-cancel-button="true" data-cancel-button-class="btn-danger" data-cancel-button-text="Cancel" data-confirm-button-text="Yes" data-task="d" data-uid="<?php echo $term_id;?>" data-confirm-button-class="btn-info"><i class="icon-trash"></i>  </a>
                  ...
                  jQuery(this).click(function() {
                     ...
                     swal({
                        ...
                        function(isConfirm) {
                           if (isConfirm) {
                              jQuery.ajax({
                                 url: '<?php echo $base_url?>/admin/pages/delete_termsdet',
                                 type: 'POST',
                                 data: {
                                    'key': key,
                                    'task': task
                                 ...
                                 success: function(response) {
                                    ...
                                    toastr.warning("Type Deleted Succesfully", "Notifications");
                                    setTimeout(function() {
                                       location.reload();
                                    }, 500);
                                 }
