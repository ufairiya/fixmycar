...
?>
	...
	<h3 class="recent_views">Recent Reviews</h3>
		<?php 
...
$count++;
			...
			$city = $values['b_street'];

			if(strpos($city, ',') == true) 
            {
                $rev_address = explode(',', $city);
				$address = $rev_address[1].','.$rev_address[2];
            }else{
                $address = $city;
            }
		    ...
		    $dates = $values['review_date'];
            if($dates!='' && $dates!='0000-00-00')
            {
                $date =date('m/d/Y',strtotime($values['review_date']));
            }
            else
            {
            	$date = ' ';
			...
			$movers_replay =trim($values['movers_review_replay']);
...
<div class="row">
				<div class="col-md-12 reviews_details  <?php echo $add_class;?> ">
						    ...
						    <div class=" boder_bottom">
						  	...
						  	<div class="customer_reviews">
							   <span class="cus_re"> Customer Review:</span><br>
							   <p><?php echo $review_comments?></p>
							   <p><?php echo $date.' '.$address ;?></p>
							   <!--<p><?php echo $state ;?></p> -->
				...
				{?>
											 ...
											 <div class="movers_reviews">
											   <span class="cus_re"> Movers Response:</span><br>
