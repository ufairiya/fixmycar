                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-10  text-center">
                            <div class="single-slider slider-1">
                                <p class="slider-title">Search <span class="text-uppercase slider-span">Garages</span> </p>
                                <p class="sub-title">Please 
                                Enter Eircode or Address to search the available garages</p>
                                        ...
                                        <form id="example_form">
                                            <div class="address_container">
                                                <div class="form-group">
                                                    ...
                                                    <div class="clear"></div>
                                                    <div class="col-md-9" id="seelctaadd">
                                                        ...
                                                        <button type="submit" class="btn btn-default searchgargae" id="search"><i class="fa fa-search" aria-hidden="true"></i> get Eircode </button>
                                                    ...
                                                    <option value="90">90 miles</option>
                                                     ...
                                                     <div class="col-md-2 col-sm-12">  <button class="btn btn-theme tm-btn-search home_search_btn_stlr"  ><i class="fa fa-search" aria-hidden="true"></i> Search </button>  </div>
                                                    </div>
                                                </div>
                                                 <div class="clear"></div>
...
<?php
 ...
 // echo distance1(53.340316, -6.257731, 53.2804913,-6.1503858, "MI") . " Miles<br>";
    ...
    function geolocate_function(postcode,latitude,longitude)
    {
       ...
       //get nearest garage
        jQuery.ajax({
          ...
          jQuery.ajax({
            url : '<?php echo BASE_URL;?>/home/getnearst_garages_display?postcode='+postcode+'&latitude='+latitude+'&longitude='+longitude,
              type: 'POST',dataType:'html',
              success:function(response){
                //alert(response);
                $('#disptab1').html(response);
                var rooms = $('.lists');
var roomList = $('#sortlist');
...
function sortDesc(){
    roomList.empty();
    rooms.sort(function(a, b){
      return $(b).data('miles')-$(a).data('miles') 
    });
    roomList.append(rooms);
   // alert(rooms) ;
}
   ...
   $(document).ready(function(){
    var postcode='641047';
    var latitude='11.15937';
    var longitude='76.94255';
    jQuery.ajax({
            url : '<?php echo BASE_URL;?>/home/getnearst_garages_display_default?postcode='+postcode+'&latitude='+latitude+'&longitude='+longitude,
              type: 'POST',dataType:'html',
              success:function(response){
...
foreach($garage_detailsdata as $gdata){
    ...
    $star_count_tol =  $gdata['average_rating'];
                           ...
                           for( $i=1 ; $i<= 5; $i++ )
                            ...
                            { 
                                ...
                                { 
                                   ...
                                   $movers_div .='<li style="list-style: none;float:left;color:#c3d9ba;" class="star" data-value="'.$i.' " >
                                     <i class="fa fa-star fa-fw"></i>
                                     </li>';

                                }
                            } 
                            $reviews ='<span class="reviewcount">'.get_ratecount_garage($garage_id).' '.'Reviews</span>';
                           echo $movers_div.'<br/>';

?> 
            </div>
            <div class="readreviews">
              <a href="#"><i class="fa fa-comment" style="padding-right: 3px;"></i> Read review</a>
            </div>
       ...
       <div class="centeralign" style="margin-top:10px;"><a id="viewlink" href="<?php echo $base_url;?>home/garagedetail/<?php echo $garage_id;?>" class="button">View Garage Profile</a></div>
     </div><!-- Block ends -->
  </div>
  <?php
}
?>
 ...
 <section class="how-it-works section-padding section_pading_stl">
        <div class="content">   
 <div id="disptab">
   <h4>Top 20 Garages</h4>
   <div class="row" style="padding: 20px 0px;">
     <div class="col-md-3"></div>
     <div class="col-md-3"> 
      <select id="distance-sort" class="form-control">
        <option value="0">Short by Distance</option>
        <option value="1">Low Distance to High</option>
        <option value="2">High Distance to Low</option>
        </select>
      </div>
     <div class="col-md-3">
       <select id="rating-sort" class="form-control">
        <option value="0">Short by Rating</option>
        <option value="1">Low Rating to High</option>
        <option value="2">High Rating to Low</option>
        </select>
...
<script>
  $(document).ready(function(){
var rooms = $('.lists1');
var roomList = $('#sortlist1');
// $(document).change,"#distance-sort",function(){ 
//         if($(this).val() == 1){
//        sortAsc();
...
$('.home_search_btn_stlr').click(function(e){
   $('#seelctaadd .errorspan').html('');
    ...
    var radius = 2; //$( "#radius option:selected" ).val(); 
...
function geolocate_function_search(postcode,latitude,longitude,miles)
    {
       ...
       //get nearest garage
        jQuery.ajax({
            ...
            toastr.success("Map updated", "Notifications");
