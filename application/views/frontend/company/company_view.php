                            ...
                            <div class="portlet light portlet-fit portlet-datatable ">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-dark sbold uppercase"> Customer Info - <?php echo $customerName.$customerID;?>
                                        </span>
                                    </div>
                                   <!--  <div class="actions">
                                    ...
                                    <form id="status_update_form" action="javascript:void(0)" class="form-horizontal" method="POST">
                                     ...
                                     <input type="hidden" name="customer_id" value="<?php echo $customerID;?>" class="cus_id">
                                ...
                                <div class="portlet-body">
                                    <div class="tabbable-line">
                                        <ul class="nav nav-tabs nav-tabs-lg">
                                            <li class="active">
                                                <a href="#customerinfo" data-toggle="tab"> Details </a>
                                            </li>
                                            <li>
                                            ...
                                            <a href="<?php echo BASE_URL.'/invoice/create/'.$company_id;?>" class="btn btn-circle btn-success"><i class="fa fa-plus"></i> New Order</a>
                                            <?php } ?>
                                           <!--  <li>
                                                <a href="#salesREP" data-toggle="tab"> Sales REP Window </a>
                                            </li> -->
                                        </ul>
                                        <div class="tab-content">
                                            <div class="tab-pane active" id="customerinfo">
                                               <?php echo $companyDetailsView;?>
                                            </div>
                                            <div class="tab-pane" id="invoices">
                                                <?php echo $customerInvoices;?>
                                            </div>
                                            <div class="tab-pane" id="commission">
                                                <?php echo $customerCommission;?>
                                            </div>
                                            <div class="tab-pane" id="history">
                                               <?php echo $customerHistory;?>
                                            </div>
...
jQuery(document).on('click','.status_update',function(){
  var form1 = $('#status_update_form');
    jQuery.ajax({
    url : '<?php echo BASE_URL;?>/company/updateCustomer_staus',
    type: 'POST',
    dataType:'JSON',
