...
<div class="col-md-12 movers_form movers_profile" style="display:block">
  <div class="col-md-12 movers_title">
      ...
      <div class="col-md-6 text_right">
         <a href="<?php echo BASE_URL;?>/home/edit_basic_customer/<?php echo $user_id; ?>" data-target="#ajax" data-toggle="modal" data-backdrop="static"  data-backdrop="static" data-keyboard="false" class="btn btn-theme-border float-right"><i class="fa fa-edit"></i> Edit </a>
